...
class TestFibonacci(unittest.TestCase):
    ...
    def test_fibonacci_iterativo_base(self):
        self.assertEqual(fibonacci_no_recursivo(0), 0)
        self.assertEqual(fibonacci_no_recursivo(1), 1)
        self.assertEqual(fibonacci_no_recursivo(2), 1)

    def test_fibonacci_iterativo_normal(self):
        self.assertEqual(fibonacci_no_recursivo(5), 5)
        self.assertEqual(fibonacci_no_recursivo(10), 55)
